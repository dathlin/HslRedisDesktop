...
namespace HslRedisDesktop
{
	public partial class FormMain : Form
	{
		...
		private string SettingsPath = Path.Combine( Application.StartupPath, "connect.txt" );
		...
		private void ThreadPoolCheckVersion( object obj )
		{
			...
			HslCommunication.OperateResult<HslCommunication.NetHandle, string> read = simplifyClient.ReadCustomerFromServer( 400, Utils.Version.ToString( ) );
			if (read.IsSuccess)
			{
